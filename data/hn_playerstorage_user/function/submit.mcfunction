...
#will send the contents of my_namespace:my_storage contents to a player spesific location
...
function hn_playerstorage:hn_playerstorage_user/submit with storage hn_playerstorage:binbuilder
